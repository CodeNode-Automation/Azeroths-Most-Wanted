...
class WarEffortThresholdTests(unittest.TestCase):
    ...
    def test_source_templates_and_shells_reflect_updated_thresholds(self):
        ...
        self.assertIn("Target: maintain 70% of the active raid-ready roster at weekly reset.", template_text)
        self.assertIn("No active raid-ready characters were available this week.", template_text)
        ...
        self.assertIn('.home-war-effort-section .weekly-challenges-flex-container > .war-effort-home-card:last-child:nth-child(odd)', war_effort_css_text)
        ...
        self.assertIn("Maintain 70% of the active raid-ready roster captured at weekly reset.", shell_text)
