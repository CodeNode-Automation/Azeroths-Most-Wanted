...
class HomepageCleanupTests(unittest.TestCase):
    ...
    def test_homepage_campaign_chronicle_surface_was_removed(self):
        ...
        self.assertIn('class="home-section-nav-link">Status</a>', template_text)
        self.assertIn('class="home-section-nav-link">Roster</a>', template_text)
        self.assertIn('class="home-section-nav-link">War Effort</a>', template_text)
        self.assertIn('class="home-section-nav-link">Standouts</a>', template_text)
        self.assertIn('class="home-section-nav-link">Councils</a>', template_text)
        self.assertIn('class="home-section-nav-link">Analytics</a>', template_text)
    ...
    def test_homepage_section_nav_hashes_are_scrolled_by_the_router(self):
        ...
        self.assertIn("if (HOMEPAGE_SECTION_HASHES.has(hash)) {", script_text)
